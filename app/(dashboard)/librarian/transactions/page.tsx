    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">
          Review all physical books currently on-loan, completed check-in returns, and system-wide renewal history.
        </p>
      </div>
      ...
      <div className="glass-card p-5 rounded-2xl border border-slate-100 flex items-center justify-between shadow-sm">
        <div className="relative w-full">
          ...
          <input
            type="text"
            placeholder="Filter transactions by student registration ID, email or book title..."
            value={search}
      ...
      <div className="glass-card rounded-2xl border border-slate-100 overflow-hidden shadow-sm">
        {isLoading ? (
          ...
          <div className="min-h-[250px] flex flex-col items-center justify-center text-center p-6 bg-white rounded-2xl">
            ...
            <span className="text-slate-400 text-sm font-semibold mt-2">No Transactions Found</span>
            <span className="text-slate-300 text-xs mt-1">No historical logs match your search.</span>
          </div>
        ) : (
